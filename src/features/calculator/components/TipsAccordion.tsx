...
export function TipsAccordion() {
  ...
  return (
    <div className="mt-8 bg-carbon-900/50 rounded-xl border border-white/10 overflow-hidden">
      <button
      ...
      >
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 bg-carbon-950 rounded-lg flex items-center justify-center">
        ...
        <div className="px-6 pb-6 space-y-4">
          {TIPS.map((tip, i) => (
            <div key={i} className="flex gap-4">
              <div className="w-8 h-8 bg-carbon-950 rounded-full flex items-center justify-center flex-shrink-0 text-lg">
                {tip.icon}
              </div>
              <div>
